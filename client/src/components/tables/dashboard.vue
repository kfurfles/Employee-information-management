<template>
    <ev-container class="ev-dashboard-table">
        <b-table :items="items" :fields="fields">
            <template #actions="{ item }">
                <div class="d-flex">                
                    <button type="button" class="invisible btn btn-outline-info mr-1" @click="$emit('onEdit',item)">
                    ...
                    <button type="button" class="invisible btn btn-outline-danger ml-1" @click="confirmDel(item)">
